...
## Lean 形式化
- `shapeShiftM`, `shapeShiftM_involution`, `card_PBPSet_M_shapeShift` in `CountingProof/ShapeShift.lean`
- PBPSet wrapper：`prop_10_2_PBP_M`, `lemma_10_3_M` in `CountingProof/Section10.lean`
