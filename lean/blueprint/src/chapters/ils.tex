...
\begin{lemma}[Twist preserves signature]
  ...
  \leanok
  \uses{def:charTwistCM, def:sign, def:signRow, def:twistBD}
...
\begin{lemma}[Twist preserves first-column signature]
  ...
  \leanok
  \uses{def:charTwistCM, def:firstColSign, def:firstColSignRow, def:twistBD}
...
\begin{lemma}[Augmentation signature formula]
  ...
  \leanok
  \uses{def:augment, def:firstColSign, def:firstColSignRow, def:sign, def:signRow}
  For $p_0, q_0 \geq 0$:
  \[
...
\begin{definition}[Theta lift $\hat\vartheta$]
  ...
  \leanok
  \uses{def:ILS, def:augment, def:charTwistCM, def:firstColSign, def:sign, def:truncate}
...
\begin{theorem}[Theta lift signature preservation]
  ...
  \leanok
  \uses{def:augment, def:firstColSign, def:firstColSignRow, def:sign, def:signRow, def:thetaLift, lem:augment_sign, lem:twist_fcSign, lem:twist_sign}
...
\begin{theorem}[Theta lift first-column signature]
  ...
  \leanok
  \uses{def:ILS, def:augment, def:charTwistCM, def:firstColSign, def:firstColSignRow, def:sign, def:thetaLift, lem:twist_fcSign}
...
\begin{theorem}[Theta lift first-entry formula]
  ...
  \leanok
  \uses{def:augment, def:charTwistCM, def:thetaLift, def:twistBD}
