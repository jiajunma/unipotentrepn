...
def dpart2LStree(tdict, dpart, rtype, increase=False):
    """
    tree dict
    """
...
def dpart2graph(dpart, rtype='C', increase=False, format='svg'):
    tdict = {}
    dpart2LStree.LS_data=dict()
    dpart2LStree(tdict,dpart,rtype=rtype,increase=increase)
    print("here")
    g = Digraph(name='Lift Tree',
                filename='lift_tree',
                node_attr={'shape':'box'},
